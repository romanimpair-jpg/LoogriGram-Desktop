...
void AutostartToggle(bool enabled, Fn<void(bool)> done) {
	...
	const auto success = ManageAppLink(
		...
		FOLDERID_Startup,
		L"-autostart",
		L"LoogriGram autorun link.\n"
		"You can disable autorun in LoogriGram settings.");
	if (done) {
...
void psSendToMenu(bool send, bool silent) {
	ManageAppLink(
		...
		FOLDERID_SendTo,
		L"--",
		L"LoogriGram send to link.\n"
		"You can disable send to menu item in LoogriGram settings.");
}
