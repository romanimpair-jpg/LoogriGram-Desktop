...
bool Message::getStateText(
	...
	if (const auto rich = richpage()) {
		...
		// LoogriGram: a checkbox in an article could be ticked, which edits
		// the message. An article cannot be written or edited here, so the
		// marker is drawn but does nothing.
