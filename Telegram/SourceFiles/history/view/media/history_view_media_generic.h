...
// LoogriGram: moved here from the collectible gift view, which is
// deleted. None of these is a gift concept - they are MediaGenericPart
// subclasses used by the empty-chat card and the "added to community"
// message, and they only ever lived there by accident of who wrote
// them first.
