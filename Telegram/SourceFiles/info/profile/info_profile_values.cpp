...
// LoogriGram: PeerGiftsCountValue counted a peer's received gifts, and was
// forced to zero to hide the profile row, the profile tab and the stories
// page entry at once. All three are deleted now, so it is too.
