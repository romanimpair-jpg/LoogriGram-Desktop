...
void BoostRow::init() {
	if (!PeerListRow::special()) {
		...
		// LoogriGram: a boost bought with stars drew a star badge over its
		// row here. The row still says when the boost expires; the badge
		// went with the credits graphics.
