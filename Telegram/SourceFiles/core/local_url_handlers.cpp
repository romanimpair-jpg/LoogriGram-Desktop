...
QString TryConvertUrlToLocal(QString url) {
	...
	if (telegramMeMatch) {
		...
		// LoogriGram: an nft/ or auction/ link was rewritten into a tg://
		// link for a collectible gift or a gift auction. Neither of those
		// is registered any more, so the rewrite only manufactured a link
