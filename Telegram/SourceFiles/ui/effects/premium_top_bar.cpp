...
, _ministars(
	...
	// LoogriGram: no 3D star, diamond or coin. What is left is the branch
	// upstream already runs when the hardware cannot do them - the flat SVG
	// logo and the 2D ministars - so nothing here is half-wired.
